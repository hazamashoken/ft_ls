...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/05 00:46:26 by tliangso          #+#    #+#             */
/*   Updated: 2024/03/05 00:46:34 by tliangso         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_quotearg.h"
#include "ft_quote.h"
#include "ft_minmax.h"
      ...
      if (backslash_escapes
          ...
          && (i + quote_string_len
              <= (argsize == SIZE_MAX && 1 < quote_string_len
                  ...
                  ? (argsize = ft_strlen (arg)) : argsize))
          && ft_memcmp (arg + i, quote_string, quote_string_len) == 0)
        {
          if (elide_outer_quotes)
            goto force_outer_quoting_style;
          is_right_quote = true;
